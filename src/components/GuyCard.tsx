...
interface GuyCardProps {
  guy: LittleGuy;
  isSelected: boolean;
  stackPosition: number | null; // 1-indexed position in stack or null
      ...
      <div className="pt-2 border-t border-[#1c2230] mt-auto">
        ...
        {expanded && (
          <div
            ...
            className="mt-2.5 p-2.5 rounded-lg bg-[#0a0c12] border border-[#232a3b] text-[11px] font-mono text-[#cbd5e1] leading-normal"
          >
