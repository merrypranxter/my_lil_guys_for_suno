...
export const MOUTH_DONORS: MouthDonor[] = [
  ...
  donor(
    ...
    ['mouth-trait-pharyngeal-emphatic', 'mouth-trait-gemination', 'mouth-trait-root-pattern-interlock'],
    ['consonants', 'vowels', 'larynx', 'timing', 'morphology'],
  ...
  donor(
    ...
    ['mouth-trait-vowel-harmony', 'mouth-trait-agglutinative-chain'],
    ['vowels', 'phonotactics', 'morphology'],
  ),
  donor(
    'lang-hungarian',
    'HUNGARIAN',
  ...
  donor(
    ...
    ['mouth-trait-lexical-tone', 'mouth-trait-vowel-length', 'mouth-trait-bound-verb-packing'],
    ['tone', 'vowels', 'timing', 'morphology'],
    ['Use bound verb packing as a structural transfer only; do not fabricate Cherokee-looking surface forms or claim the hybrid is grammatical Cherokee.'],
  ),
  donor(
    'lang-inuktitut',
    'INUKTITUT',
    'Velar/uvular contrast, length, and assimilation provide strong mouth-position and timing behavior.',
    ['mouth-trait-vowel-length', 'mouth-trait-polysynthetic-suffix-chain'],
    ['consonants', 'phonotactics', 'timing', 'morphology'],
    ['Use suffix-chain/polysynthetic pressure as a structural transfer only; do not present invented chains as grammatical Inuktitut.'],
  ),
  donor(
    'lang-nuxalk',
    'NUXALK',
